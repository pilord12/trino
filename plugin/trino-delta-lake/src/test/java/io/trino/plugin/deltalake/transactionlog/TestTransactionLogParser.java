...
public class TestTransactionLogParser
{
            ...
            throws Exception
    {
        ...
        assertEquals(getMandatoryCurrentVersion(null, appendPath(basePath, "simple_table_without_checkpoint")), 9);
        assertEquals(getMandatoryCurrentVersion(null, appendPath(basePath, "simple_table_ending_on_checkpoint")), 10);
        assertEquals(getMandatoryCurrentVersion(null, appendPath(basePath, "simple_table_past_checkpoint")), 11);
    }
}
