        ...
        implements DeltaLakeTableStatisticsProvider
{
    ...
    public TableStatistics getTableStatistics(ConnectorSession session, DeltaLakeTableHandle tableHandle, TableSnapshot tableSnapshot)
    {
        ...
        for (AddFileEntry addEntry : transactionLogAccess.getActiveFiles(tableSnapshot, tableHandle.getMetadataEntry(), tableHandle.getProtocolEntry(), session, tableHandle.getSchemaTableName())) {
