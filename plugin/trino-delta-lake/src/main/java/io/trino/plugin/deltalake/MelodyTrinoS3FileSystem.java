...
//
//public class MelodyTrinoS3FileSystem
//        extends FileSystem
...
//    private final HashMap<String, AmazonS3> s3Clients = new HashMap<>();
//    private final HashMap<String, AWSStaticCredentialsProvider> providers = new HashMap<>();
...
//    private final TokenExchangeBuilder exchangeBuilder = new TokenExchangeBuilder();
...
//    }
//
//    private AmazonS3 getClientFor(String token, String org, String domain) {
//        AmazonS3 client = s3Clients.get(token);
//
//        if (client == null) {
////            var api = new AccessManagerApi(); TODO use java API when a function is added for just token, not client/secret
////            api.requestToken()
//
...
//
//            var payload = exchangeBuilder.encode(exchangeBuilder.buildExchangeRequestFor(domain, org));
//
//            try {
...
//
//                var v1Creds = new BasicSessionCredentials(
//                        credentials.AccessKeyId(),
//                        credentials.SecretAccessKey(),
//                        credentials.SessionToken()
//                );
//                var cp = new AWSStaticCredentialsProvider(v1Creds);
//
//                client = createAmazonS3Client(getConf(), clientConfig, cp);
//
//                s3Clients.put(token, client);
//                providers.put(token, cp);
//            }  catch (IOException e) {
...
//
//            for (AWSStaticCredentialsProvider cp: providers.values()) {
//                if (cp instanceof Closeable closeable) {
//                    closer.register(closeable);
//                }
//            }
//
//            for (AmazonS3 c: s3Clients.values()) {
//                if (c != null) {
//                    closer.register(c::shutdown);
//                }
//            }
//        }
//    }
...
//    }
//
//    private AmazonS3 createAmazonS3Client(Configuration hadoopConfig, ClientConfiguration clientConfig, AWSStaticCredentialsProvider cp)
//    {
